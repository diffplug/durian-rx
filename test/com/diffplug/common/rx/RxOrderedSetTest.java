...
public class RxOrderedSetTest {
	...
	public void testDisallowDuplicates() {
		// first and last
		testCase(Arrays.asList(1, 2, 3, 4, 5), Arrays.asList(1, 2, 3, 4, 5, 1), OnDuplicate.TAKE_FIRST,
				Arrays.asList(1, 2, 3, 4, 5));
		testCase(Arrays.asList(1, 2, 3, 4, 5), Arrays.asList(1, 2, 3, 4, 5, 1), OnDuplicate.TAKE_LAST,
